{#
  ...
  ad-hoc test runs (see docs/METRICS.md's Phase 2 section), not a genuinely continuous
  ...
  Phase 1's scheduler has been running for a while and Valve renames or re-rarities an
