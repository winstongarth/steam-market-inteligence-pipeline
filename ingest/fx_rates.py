"""Daily FX rates for cross-currency dislocation analysis.
...
# Steam currency code -> ISO code, matching dbt/seeds/dim_currency.csv (measured,
# corrected mapping — docs/FINDINGS.md).
